(function ($) {
    $.fn.grtyoutube = function (options) {
        return this.each(function () {
            var getvideoid = $(this).attr("youtubeid"); var settings = $.extend({ videoID: getvideoid, autoPlay: !0, theme: "dark" }, options); if (settings.autoPlay === !0) { settings.autoPlay = 1 } else if (settings.autoPlay === !1) { settings.autoPlay = 0 }
